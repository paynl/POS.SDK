...
| configuration.pinPadLayoutParams         | Object              | Only relevant for Android Softpos                                                                                                                       |
...
After a successful transaction, it is possible to print the ticket via the SDK (if the terminal has a printer build-in).
