...
| configuration.pinPadLayoutParams.portraitNumberSize    | Integer              | The fontsize of the number while in Portrait. Note, this does not resize the button (default: 56dx)                                                                                                                                                                                             |
| configuration.pinPadLayoutParams.landscapeNumberSize   | Integer              | The fontsize of the number while in Landscape. Note, this does not resize the button (default: 46dx)                                                                                                                                                                                            |
| configuration.pinPadLayoutParams.specialButtonTextSize | Integer              | The fontsize of the special buttons. Note, this does not resize the button (default: 56dx)                                                                                                                                                                                                      |
