...
| pinPadLayoutParams.portraitNumberSize    | Integer              | The fontsize of the number while in Portrait. Note, this does not resize the button (default: 56dx)                                                                                                                                                                                                          |
| pinPadLayoutParams.landscapeNumberSize   | Integer              | The fontsize of the number while in Landscape. Note, this does not resize the button (default: 46dx)                                                                                                                                                                                                         |
| pinPadLayoutParams.specialButtonTextSize | Integer              | The fontsize of the special buttons. Note, this does not resize the button (default: 56dx)                                                                                                                                                                                                                   |
...
| `forService`           | object?  | A transaction can be re-routed to another service (within the same Merchant). NOTE: this is optional                                                                              |
| `forService.serviceId` | string   | The service code (example: SL-1234-1234). A list of services can be requested via: [Merchant:info](https://developer.pay.nl/reference/merchants_info)                             |
| `forService.secret`    | string   | The secret belonging to this service                                                                                                                                              |
